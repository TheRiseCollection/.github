...
$ cat README
 ...
 THE RISE COLLECTION
 ───────────────────
 A software company focused on crafting innovative brands, digital assets,
...
$ ls -la products/
 ...
 BL1NK              Mobile game
 Stack 8            iOS game
 Keep On Trucking   Mobile game
 Attack Of The Circle  Mobile game
 devKick            Developer tool
 styleSweeper       Developer tool
 controller-chat    Developer tool
 Dividend Chaser   Financial API
...
$ therisecollection --features
 ...
 ✓ ASSETS    — 3D models, games, applications
